...
impl Consolidator {
    ...
    fn targeted_dep_context_for(
        target: &str,
        target_triples_filter: &Vec<String>,
        ...
        CrateTargetedDepContext {
            ...
            conditions: generate_bazel_conditions(&triples).unwrap(), // UNWRAP: the triple was generated by get_matching_bazel_triples()
        }
    }
        ...
        I: IntoIterator<Item = (String, Vec<String>)>,
    {
        ...
        extra_bazel_deps.into_iter().for_each(|(target, deps)| {
            let targeted_dep_context = crate_targeted_dep_contexts.entry(target.clone()).or_insert(
        ...
        extra_bazel_data_deps
            ...
            .for_each(|(target, deps)| {
                let targeted_dep_context =
                    crate_targeted_dep_contexts.entry(target.clone()).or_insert(
                        Self::targeted_dep_context_for(&target, target_triples_filter),
                    );
                targeted_dep_context
                    .deps
